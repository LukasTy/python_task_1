...
def outputTotalResults():
	...
	try:
		...
		outputCharactersContent = "\n==========TOTAL character details for all files==========\n\n"
		for character, repetitions in sorted(allCharacters.items(), key=lambda x:x[1]):
			outputCharactersContent += character + " mentioned: " + str(repetitions) + "\n"
